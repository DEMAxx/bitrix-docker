...
> В случае возникновения проблем с кодировкой необходимо изменить файл after_connect_d7.php. Изменения не должны попасть на прод.
...
Установка сайта и окружения:

1) Склонируйте репозиторий bitrix-docker (https://git.lab4u.ru/lab4u-back-end/bitrix-docker)
2) В директорию htdocks внутри bitrix-docker склонируйте репозиторий Lab4uRefactor (https://git.lab4u.ru/lab4u-back-end/Lab4uRefactor)
3) Рядом с директорией bitrix-docker склонируйте репозиторий lab4ubitrixcore22600300 (https://git.lab4u.ru/lab4u-back-end/lab4ubitrixcore22600300)

В клоне lab4ubitrixcore22600300 поставьте ветку develop
